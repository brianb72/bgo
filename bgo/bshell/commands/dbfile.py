...
from database import DBAccess, DBAccessGameRecordError, DBAccessLookupNotFound, DBAccessException, DBAccessDuplicate
...
"""
    ...
    def do_command(self, *args):
        ...
        try:
            game_count = self.state.db_access.get_number_of_games_in_database()
        except DBAccessException as e:
