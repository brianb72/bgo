...
sgf_parser.py
    ...
    Decodes fields
    Can be directly inserted into database with db_access.add_game_record(sgf_parser_object)
...
class SGFParser(object):
    ...
    def import_from_sgf_file_text(self, sgf_file_text, sgf_file_name=""):
        try:
            ...
            raise SGFParserException('sgf_parser::import_from_sgf_file_text() - [%s]' % (e,))
