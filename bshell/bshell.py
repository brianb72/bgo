...
from bgo.db_access import DBAccess, DBAccessDuplicate, DBAccessException, DBAccessGameRecordError, DBAccessLookupNotFound
import bgo.game_of_go as game_of_go
import bgo.go_board as go_board


default_sqlfile = 'baduk.sqlite'
...
def main_loop(database):
    ...
    game_count = db_access.get_game_count()
